#!/usr/bin/env python3
"""
Generate test data files for F.R.O.G. Data Visualizer

This script creates various CSV files with different data patterns
to test all visualization types in the application.
"""
...
print("Generating test data files for F.R.O.G. visualization testing...")
...
print("\nCreated files:")
print("- data/time_series_test.csv      (Weather sensor data)")
print("- data/scatter_test.csv          (2D point cloud)")
print("- data/bar_chart_test.csv        (Sales by category)")
print("- data/histogram_test.csv        (Population metrics)")
print("- data/box_plot_test.csv         (Treatment comparisons)")
print("- data/heatmap_test.csv          (2D grid values)")
print("- data/correlation_test.csv      (Correlated variables)")
print("- data/scatter3d_test.csv        (3D point cloud)")
print("- data/radar_test.csv            (Multi-dimensional comparison)")
print("- data/distribution_test.csv     (Statistical distributions)")
print("- data/contour_test.csv          (Surface data)")
print("- data/parallel_coordinates_test.csv (Multi-feature dataset)")
print("\nUse these files to test different visualization types in F.R.O.G.!") 